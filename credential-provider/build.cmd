...
set "SRC=%ROOT%WatchUnlockCredentialProvider.cpp"
...
cl.exe /nologo /EHsc /W4 /DUNICODE /D_UNICODE /DWIN32_LEAN_AND_MEAN /LD ^
  /Fe:"%OUT%\WatchUnlockCredentialProvider.dll" ^
  /Fo:"%OUT%\WatchUnlockCredentialProvider.obj" ^
  "%SRC%" ^
  /link /DEF:"%ROOT%WatchUnlockCredentialProvider.def" ^
  ole32.lib advapi32.lib crypt32.lib credui.lib secur32.lib shell32.lib
